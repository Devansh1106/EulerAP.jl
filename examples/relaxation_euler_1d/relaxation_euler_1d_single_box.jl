...
init_filename = "relaxation_euler_1d_single_box_$(mesh_str)_$(equations.epsilon)_initial.h5"
...
mesh_str = join(mesh.cells_per_dimension, "x")
filename = "relaxation_euler_1d_single_box_$(mesh_str)_$(equations.epsilon).h5"
save_solution(sol,
              semi,
